<template>
  <div>
    ...
    <div class="flex">
      <div class="sidebar">
        <SidebarFilter
          :cocktails="cocktails"
          :searchH="searchH"
          :optionsDeg="optionsDeg"
          :optionsTaste="optionsTaste"
          :optionsBase="optionsBase"
          :optionsIngridients="optionsIngridients"
          :removedIngridients="removedIngridients"
          @getIngridient="getSelectedIngridients"
          @getDeg="getSelectedDeg"
          @getTaste="getSelectedTaste"
          @getBase="getSelectedBase"
    ...
    <div class="center">
      <button @click="showMore" v-if="!this.pageEnd" class="btn_pag">
        Показать еще...
      </button>
      <button
        @click="goBack"
        v-if="
          this.pageEnd &&
          (this.pagination_items_per_page >= this.searchH.length ||
            Math.ceil(
              this.searchH.length / this.pagination_items_per_page != 1
            ))
        "
        class="btn_pag"
      >
    ...
    return {
      cocktails: [
        ...
        },
        {
          ...
          src: "img/Evolution.png",
          price: 150,
          rate: 3,
        },
        {
          id: 5,
          title: "Сломан, но не сломлен",
          deg: "Слабоалкогольный",
          taste: ["Цитрусовый"],
          base: "На хересе",
          ingridients: [
          ...
          src: "img/DownButNotOut.png",
          price: 300,
          rate: 5,
        },
        {
          id: 6,
          title: "Любовь к Милану",
          deg: "Крепкий",
          taste: ["Кислый", "Горький"],
          base: "На виски",
          ingridients: [
            "Лед",
        ...
        },
        {
          ...
          src: "img/NorthernLights.png",
          price: 500,
          rate: 3,
        },
        {
          id: 8,
          title: "Пача Сан-Паулу",
          deg: "Слабоалкогольный",
          taste: ["Фруктовый", "Сладкий"],
          base: "На роме",
          ingridients: [
            "Лед",
            "Темный ром",
          ...
          src: "img/PachaSaoPaulo.png",
          price: 250,
          rate: 2,
        },
        {
          id: 9,
          title: "Шотландский флип",
          deg: "Крепкий",
          taste: ["Пряный"],
          base: "На виски",
          ingridients: [
        ...
        },
        {
          ...
          taste: ["Сладкий"],
          base: "На игристом",
          ingridients: ["Лед", "Апероль", "Просекко", "Содовая", "Апельсин"],
          src: "img/Aperol.png",
          price: 250,
          rate: 4,
        },
        ...
        },
        {
          ...
          taste: ["Горький"],
          base: "На джине",
          ingridients: ["Лед", "Лайм", "Тоник", "Лондонский сухой джин"],
        ...
        },
        {
          ...
          taste: ["Кислый", "Мятный"],
          base: "На роме",
          ingridients: ["Лед", "Содовая", "Лайм", "Мята", "Сахарный сироп"],
          src: "img/Mojito.png",
          price: 180,
          rate: 5,
        },
  ...
  methods: {
    getSelectedIngridients(data) {
      if (!this.removedIngridients.includes(data.ingridient)) {
        ...
        localStorage.removedIngridients = JSON.stringify(
          this.removedIngridients
        );
        if (
          this.pagination_items_per_page >= this.searchH.length ||
          this.page ==
            Math.ceil(this.searchH.length / this.pagination_items_per_page)
        ) {
          this.pageEnd = true;
        }
    ...
    changePage(page_num) {
      ...
      this.pagination_offset =
        this.pagination_items_per_page * page_num -
      ...
      this.searchH = this.cocktails_list.filter(
        (item, index) =>
          index >= this.pagination_offset &&
    ...
    goBack() {
      ...
      this.cocktails_list = this.searchH.filter(
        (item, index) =>
          index >= this.pagination_offset &&
          index < this.pagination_offset + this.pagination_items_per_page
      );
    ...
    searchH() {
      return this.cocktails.filter(
        (cocktail, index) =>
          ...
          !cocktail.ingridients.some((e) =>
            this.removedIngridients.includes(e)
          ) &&
          ...
          cocktail.price >= this.min_price &&
          cocktail.price <= this.max_price
      );
    },
    pagesCount() {
